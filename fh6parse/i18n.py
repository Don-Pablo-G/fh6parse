...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "machine_max_rpm": "Max spindle (rpm)",
        "machine_atc_group": "ATC position (G53 mm)",
        "machine_offset_group": "Work offset (G53 mm)",
        "machine_mrzp_group": "MRZP (G53 mm, Haas 255–257)",
        "machine_travel_group": "Travel (G53 mm)",
        "machine_ax_x": "X",
        "machine_ax_y": "Y",
        "machine_ax_z": "Z",
        "machine_x_min": "X min",
        ...
        "ticket_split": "Time split",
        "ticket_split_short": "SPLIT",
        "ticket_split_all": "ALL",
        "ticket_split_legend": "G=G0 F=cut R=rot C=cyc P=prb A=ATC",
        "ticket_split_feeds": "F {feeds}",
        "ticket_split_rapid": "G0",
        "ticket_split_feed": "F",
        "ticket_split_rotary": "R",
        "ticket_split_canned": "C",
        "ticket_split_probe": "P",
        "ticket_split_atc": "ATC",
        ...
        "ticket_g53_frame": "G53 ATC/offset",
        ...
        "ticket_warn_offset_late": "{offset} after operation started ({line})",
        "ticket_warn_s_max": "{s} exceeds mill max {max}",
        "ticket_warn_g68_g69": "G68 {start} to G69 {end}",
        "ticket_warn_g68_open": "G68 {start} without G69",
        "ticket_g54_heading": "Work offset origin in G53 mm",
        "ticket_g54_sw": "SW {xy}",
        "ticket_g54_se": "SE {xy}",
        "ticket_g54_ne": "NE {xy}",
        "ticket_g54_nw": "NW {xy}",
        "ticket_g54_center": "Center {xy}",
        "ticket_g54_dia": "Max Ø G41/G42 centred {d} mm",
        "ticket_g54_z": "Offset Z G53 {z0} … {z1} mm",
        "ticket_g54_too_big": "Work XY larger than machine travel.",
        "ticket_g54_out": "Stored offset is outside this box.",
        "ticket_g54_ok": "Stored offset is inside this box.",
        "ticket_g54_alt": "Work offset origin box",
        "ticket_g54_dwo_heading": "Work offset origin in G53 mm (DWO limits)",
        "ticket_g54_dwo_poses": "Machine B/C {poses}",
        "ticket_g54_dwo_corner": "{xyz}",
        "ticket_g54_dwo_center": "Center {xyz}",
        "ticket_g54_too_big_dwo": "Work at programmed B/C larger than machine travel.",
    },
    "pl": {
        ...
        "machine_max_rpm": "Max wrzeciona (obr./min)",
        "machine_atc_group": "Pozycja ATC (G53 mm)",
        "machine_offset_group": "Offset (G53 mm)",
        "machine_mrzp_group": "MRZP (G53 mm, Haas 255–257)",
        "machine_travel_group": "Skok (G53 mm)",
        "machine_ax_x": "X",
        "machine_ax_y": "Y",
        "machine_ax_z": "Z",
        "machine_x_min": "X min",
        ...
        "gui_reloaded": "Wczytano ponownie {name}",
        ...
        "ticket_split": "Rozkład czasu",
        "ticket_split_short": "ROZKŁAD",
        "ticket_split_all": "SUMA",
        "ticket_split_legend": "G=G0 F=skraw R=obr C=cykl P=sond A=ATC",
        "ticket_split_feeds": "F {feeds}",
        "ticket_split_rapid": "G0",
        "ticket_split_feed": "F",
        "ticket_split_rotary": "R",
        ...
        "ticket_warn_offset_late": "{offset} po starcie operacji ({line})",
        "ticket_warn_s_max": "{s} przekracza max wrzeciona {max}",
        "ticket_warn_g68_g69": "G68 {start} do G69 {end}",
        "ticket_warn_g68_open": "G68 {start} bez G69",
        "ticket_g54_heading": "Punkt zerowy offsetu w G53 mm",
        "ticket_g54_sw": "SW {xy}",
        "ticket_g54_se": "SE {xy}",
        "ticket_g54_ne": "NE {xy}",
        "ticket_g54_nw": "NW {xy}",
        "ticket_g54_center": "Środek {xy}",
        "ticket_g54_dia": "Maks. Ø G41/G42 wyśrodkowane {d} mm",
        "ticket_g54_z": "Offset Z G53 {z0} … {z1} mm",
        "ticket_g54_too_big": "Obróbka XY większa niż skok obrabiarki.",
        "ticket_g54_out": "Zapisany offset jest poza tym prostokątem.",
        "ticket_g54_ok": "Zapisany offset jest wewnątrz tego prostokąta.",
        "ticket_g54_alt": "Prostokąt punktu zerowego offsetu",
        "ticket_g54_dwo_heading": "Punkt zerowy offsetu w G53 mm (limity DWO)",
        "ticket_g54_dwo_poses": "Maszynowe B/C {poses}",
        "ticket_g54_dwo_corner": "{xyz}",
        "ticket_g54_dwo_center": "Środek {xyz}",
        "ticket_g54_too_big_dwo": "Obróbka przy zapisanym B/C większa niż skok obrabiarki.",
    },
}
